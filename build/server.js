    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                // });
                // promiseToProcess();
                return [4 /*yield*/, (0, sharp_1.default)(__dirname + 'img/original/coffee_cup.png')
                        .resize(300, 200)
                        .toFile(__dirname + 'img/optimized/coffee_cup.png', function (err) {
                        // output.jpg is a 300 pixels wide and 200 pixels high image
                        // containing a scaled and cropped version of input.jpg
...
app.get('/api/images', function (req, res) {
    ...
    var filepath = __dirname + "/img/optimized/".concat(req.query.filename, ".png");
    console.log(widths);
        ...
        if (fs_1.default.existsSync(filepath)) {
            for (var i = 0; i <= widths.length; i++) {
                if (widths[i] === Number(req.query.width) && heights[i] === Number(req.query.height)) {
                    res.sendFile(__dirname + "/img/optimized/".concat(req.query.filename, ".png"));
                }
                else {
                    (0, sharp_1.default)(__dirname + "/img/original/".concat(req.query.filename, ".png"))
                        .resize(Number(width), Number(height))
                        .toFile(__dirname + "/img/optimized/".concat(req.query.filename, ".png"), function (err) {
                        console.log(err);
                    });
                    res.sendFile(__dirname + "/img/optimized/".concat(req.query.filename, ".png"));
                }
